...
Route::middleware(['auth:web,admin', EnsureUserVerified::class])->group(function () {
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        Route::middleware('permission:issues.manage')->group(function () {
            ...
            Route::get('issues/{issue}/forensic-reports', [IssueForensicReportController::class, 'index'])->name('issues.forensic-reports.index');
            Route::get('issues/{issue}/forensic-reports/create', [IssueForensicReportController::class, 'create'])->name('issues.forensic-reports.create');
            Route::post('issues/{issue}/forensic-reports', [IssueForensicReportController::class, 'store'])->name('issues.forensic-reports.store');
            Route::get('issues/{issue}/forensic-reports/{forensic_report}/edit', [IssueForensicReportController::class, 'edit'])->name('issues.forensic-reports.edit');
            Route::put('issues/{issue}/forensic-reports/{forensic_report}', [IssueForensicReportController::class, 'update'])->name('issues.forensic-reports.update');
            Route::delete('issues/{issue}/forensic-reports/{forensic_report}', [IssueForensicReportController::class, 'destroy'])->name('issues.forensic-reports.destroy');
            Route::get('issues/{issue}/witness-testimonies', [IssueWitnessTestimonyController::class, 'index'])->name('issues.witness-testimonies.index');
            Route::get('issues/{issue}/witness-testimonies/create', [IssueWitnessTestimonyController::class, 'create'])->name('issues.witness-testimonies.create');
            Route::post('issues/{issue}/witness-testimonies', [IssueWitnessTestimonyController::class, 'store'])->name('issues.witness-testimonies.store');
            Route::get('issues/{issue}/witness-testimonies/{witness_testimony}/edit', [IssueWitnessTestimonyController::class, 'edit'])->name('issues.witness-testimonies.edit');
            Route::put('issues/{issue}/witness-testimonies/{witness_testimony}', [IssueWitnessTestimonyController::class, 'update'])->name('issues.witness-testimonies.update');
            Route::delete('issues/{issue}/witness-testimonies/{witness_testimony}', [IssueWitnessTestimonyController::class, 'destroy'])->name('issues.witness-testimonies.destroy');
