...
<head>
    ...
    <title>الصفحة الرئيسية | 1988</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('assets/svg/icons/1988_icon.svg') }}" />
        ...
        <div class="container">
            <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
                ...
                <div class="navbar-brand app-brand demo d-flex py-0 me-4 me-xl-8">
                    ...
                    <button class="navbar-toggler border-0 px-0 me-4" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"
                    ...
                    <a href="{{ route('website.landing-page') }}" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <span class="text-primary">
                                <img width="70" src="{{ asset('assets/svg/icons/1988_logo_dark.svg') }}" alt="1988" class="img-fluid">
                            </span>
                        </span>
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
                    <button class="navbar-toggler border-0 text-heading position-absolute end-0 top-0 scaleX-n1-rtl p-2" type="button" data-bs-toggle="collapse"
                        data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                        <i class="icon-base bx bx-x icon-lg"></i>
                    </button>
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link fw-medium" href="{{ route('website.landing-page') }}">الرئيسية</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-medium" href="{{ route('website.about-us') }}">عن المؤلف</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-medium" href="{{ route('website.about-novel') }}">الرواية</a>
                        </li>
                        <li class="nav-item">
                        ...
                        {{-- <li class="nav-item">
                            <a class="nav-link fw-medium" href="{{ route('dashboard.index') }}" target="_blank">لوحة التحكم</a>
                        </li> --}}
                    </ul>
                </div>
                ...
                <ul class="navbar-nav flex-row align-items-center ms-auto">
                    ...
                    @guest('web')
                    <li>
                        <a href="{{ route('auth.login') }}" class="btn btn-primary"><span
                                class="tf-icons icon-base bx bx-log-in-circle scaleX-n1-rtl me-md-1"></span><span class="d-none d-md-block">تسجيل الدخول</span></a>
                    </li>
                    @endguest
                    @auth('web')
                    <li>
                        <form method="POST" action="{{ route('auth.logout') }}" class="d-inline">
                            ...
                            <button type="submit" class="btn btn-primary"><span
                                class="tf-icons icon-base bx bx-log-out-circle scaleX-n1-rtl me-md-1"></span><span class="d-none d-md-block">تسجيل الخروج</span></button>
                        </form>
                    </li>
                    @endauth
                    <!-- navbar button: End -->
            ...
            <div class="container">
                <div class="row gx-0 gy-6 g-lg-10">
                    <div class="col-lg-4 col-md-6">
                        <a href="{{ route('website.landing-page') }}" class="app-brand-link mb-6 d-inline-block">
                            <img width="80" src="{{ asset('assets/svg/icons/1988_logo_dark.svg') }}" alt="1988" class="img-fluid">
                        </a>
                        <p class="footer-text footer-logo-description mb-0">
                            منصة تحقيقات تفاعلية — اكتشف الرواية، اشترِ المنتجات، وتابع الجرائم.
                        </p>
                    </div>
                    <div class="col-lg-2 col-md-3 col-sm-6">
                        <h6 class="footer-title mb-6">الموقع</h6>
                        <ul class="list-unstyled">
                            <li class="mb-3"><a href="{{ route('website.landing-page') }}" class="footer-link">الرئيسية</a></li>
                            <li class="mb-3"><a href="{{ route('website.about-us') }}" class="footer-link">عن المؤلف</a></li>
                            <li class="mb-3"><a href="{{ route('website.about-novel') }}" class="footer-link">الرواية</a></li>
                            <li class="mb-3"><a href="{{ route('website.products') }}" class="footer-link">المنتجات</a></li>
                            <li class="mb-3"><a href="{{ route('website.issues') }}" class="footer-link">الجرائم</a></li>
                            <li><a href="{{ route('website.landing-page') }}#landingContact" class="footer-link">تواصل معنا</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <h6 class="footer-title mb-6">روابط إضافية</h6>
                        <ul class="list-unstyled">
                            <li class="mb-3"><a href="{{ route('website.features') }}" class="footer-link">المميزات</a></li>
                            <li class="mb-3"><a href="{{ route('website.faq') }}" class="footer-link">الأسئلة الشائعة</a></li>
                            <li class="mb-3"><a href="{{ route('website.how-to-play') }}" class="footer-link">كيف تلعب</a></li>
                            <li class="mb-3"><a href="{{ route('website.ratings') }}" class="footer-link">التقييمات</a></li>
                            @auth('web')
                            <li><a href="{{ route('website.my-purchases') }}" class="footer-link">قسم المشتريات</a></li>
                            @endauth
                        </ul>
                    </div>
                    <div class="col-lg-3 col-md-12">
                        <h6 class="footer-title mb-6">السياسات</h6>
                        <ul class="list-unstyled">
                            <li class="mb-3"><a href="{{ route('website.privacy-policy') }}" class="footer-link">سياسة الخصوصية</a></li>
                            <li class="mb-3"><a href="{{ route('website.terms-and-conditions') }}" class="footer-link">الشروط والأحكام</a></li>
                            <li><a href="{{ route('website.return-replacement-policy') }}" class="footer-link">سياسة الاستبدال والإرجاع</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="footer-bottom py-3 py-md-5">
            <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
                <div class="mb-2 mb-md-0">
                    ...
                    <span class="footer-bottom-text"> 1988 — جميع الحقوق محفوظة.</span>
                </div>
                <div>
