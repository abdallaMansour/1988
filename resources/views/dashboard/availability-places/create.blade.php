...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0">إضافة مكان توفر</h4>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('dashboard.availability-places.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-primary">إضافة مكان التوفر</button>
                </form>
            </div>
        </div>
    </div>
