                    ...
                    <a href="{{ route('website.landing-page') }}" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <span class="text-primary">
                                <img width="100" src="{{ asset('assets/svg/icons/1988_logo_dark.svg') }}" alt="1988" class="img-fluid">
                            </span>
                        </span>
                        {{-- <span class="app-brand-text demo menu-text fw-bold ms-2">1988</span> --}}
                    </a>
                ...
                <nav class="layout-navbar container-xxl navbar-detached navbar navbar-expand-xl align-items-center bg-navbar-theme" id="layout-navbar">
                    ...
                    <div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-md-auto">
                                ...
                                <div class="dropdown-menu dropdown-menu-end p-0">
                                    <div class="dropdown-menu-header border-bottom">
                                        <div class="dropdown-header d-flex align-items-center py-3">
                                            ...
                                            <a href="javascript:void(0)" class="dropdown-shortcuts-add py-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Add shortcuts"><i
                            ...
                            @include('dashboard.partials.navbar-notifications')
                            <!-- User -->
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <div class="avatar avatar-online">
                                        @include('dashboard.partials.navbar-user-avatar')
                                    </div>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item" href="{{ auth('web')->check() && ! auth('admin')->check() ? route('dashboard.user.profile') : 'javascript:void(0);' }}">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar avatar-online w-px-40 h-auto">
                                                        @include('dashboard.partials.navbar-user-avatar', ['class' => 'w-px-40 h-auto rounded-circle'])
                                                    </div>
                                                </div>
