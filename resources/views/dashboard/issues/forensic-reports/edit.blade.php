...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-body">
                <form id="forensic-report-edit-form" action="{{ route('dashboard.issues.forensic-reports.update', [$issue, $forensicReport]) }}" method="POST">
                    @csrf
                    @method('PUT')
...
@section('page-js')
    @include('dashboard.partials.rich-text-editor-scripts', [
        ...
        'formId' => 'forensic-report-edit-form',
        'initialHtml' => old('report', $forensicReport->report ?? ''),
