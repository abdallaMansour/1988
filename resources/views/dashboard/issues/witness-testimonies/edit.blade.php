...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-body">
                <form id="witness-testimony-edit-form" action="{{ route('dashboard.issues.witness-testimonies.update', [$issue, $witnessTestimony]) }}" method="POST">
                    @csrf
                    @method('PUT')
...
@section('page-js')
    @include('dashboard.partials.rich-text-editor-scripts', [
        ...
        'formId' => 'witness-testimony-edit-form',
        'initialHtml' => old('report', $witnessTestimony->report ?? ''),
